defmodule Triggers.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      # Starts a worker by calling: Triggers.Worker.start_link(arg)
      # {Triggers.Worker, arg},
    ]
    ...
    opts = [strategy: :one_for_one, name: Triggers.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    TriggersWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
